...
async def start(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/KOT_BOTS'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/KOT_FREE_DE_LA_HOYA_OFF')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/KOT_FREE_DE_LA_HOYA_OFF'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/KOT_BOTS'),
